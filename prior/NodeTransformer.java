...
public class NodeTransformer {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Process nodes to store node types
            ...
            for (String nodeId : nodes) {
                ...
                // Collect node type and address in/out lists
                nodesList.add("'" + nodeTypes.get(nodeId) + "'");
                
                // Format addressIn as comma-separated strings
                addressInList.add(addressIn.isEmpty() ? "''" : "'" + String.join("', '", addressIn) + "'");
                
                // Group certain addressOut values together
            ...
            // Format addressOut with '' for empty nodes at the end
